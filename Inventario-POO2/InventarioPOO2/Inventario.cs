...
public class Inventario
{
    ...
    public Inventario()
    {
        ...
        Producto f = new Producto("006",  "Motherboard", 30);
    ...
    public void listarProductos() {
       ...
       foreach (var producto in ListadeProductos)
        ...
        public void salidaDeInventario(){
            ...
            Console.Write("Ingrese el codigo del producto: ");
            codigo = Console.ReadLine();
            Console.Write("Ingrese la cantidad de salida del producto: ");
            cantidad = Console.ReadLine();
         ...
         public void ajusteDeinventario(){
            ...
            Console.WriteLine("Ajuste Positivos del sistema");
            Console.WriteLine("**********************************");
            Console.Write("Ingrese el codigo del producto: ");
            codigo = Console.ReadLine();
            Console.Write("Ingrese la cantidad de Ajuste: ");
            cantidad = Console.ReadLine();
